...
/**
 * 
 * This file inserts the chat data to the Live Stream and retrives the latest chat message.
 * 
...
if ($client->getAccessToken()) {
  try {
    // Execute an API request that insert the chat message for the specific liveChatId
